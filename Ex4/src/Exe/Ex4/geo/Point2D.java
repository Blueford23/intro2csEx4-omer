 ...
 * would be used as is for testing. Ex4: you should edit and update this class!
 * 
...
public class Point2D {
	...
	public void scale(Point2D cen, double ratio) {
		////////// add your code below ///////////
		Point2D vec = Ex4Utils.kefelPoint2D(this.vector(cen), 1 - ratio);
		this.move(vec);
//		_x = Ex4Utils.roundDbl(_x + vec.x() * Math.abs(1 - ratio));
//		_y = Ex4Utils.roundDbl(_y + vec.y() * Math.abs(1 - ratio));	
		/////////////////////////////////////////
	}

	public void rotate(Point2D cen, double angleDegrees) {
		////////// add your code below ///////////
		double rad_angle = Math.toRadians(angleDegrees);
		double rtx = cen.x() + (this._x-cen.x())*Math.cos(rad_angle)-(this._y-cen.y())*Math.sin(rad_angle);
		double rty = cen.y() +(this._x-cen.x())*Math.sin(rad_angle)+(this._y-cen.y())*Math.cos(rad_angle);
		this._x = Ex4Utils.roundDbl(rtx);
		this._y = Ex4Utils.roundDbl(rty);
		/////////////////////////////////////////
	}
